...
bp = Blueprint('fourth_chall', __name__, url_prefix='/fourth_chall', template_folder='templates/template_fourth/')
user = ()
...
def fourth_chall():
    ...
    if r:
        return render_template('fourth_chall.html')
    else:
...
def strings():
    ...
    if r:
        return render_template('strings_4.html')
    else:
        return render_template('cannot_access.html')
...
def confirm_solution():
    if request.method == 'GET':
        ...
        if r:
            return render_template("confirm_solution_4.html")
        else:
            return render_template("cannot_access.html")
...
def callgraph():
    ...
    if r:
        return render_template("callgraph_4.html")
    else:
        return render_template("cannot_access.html")
...
def info():
    ...
    if r:
        return render_template("info_4.html")
    else:
        return render_template("cannot_access.html")
