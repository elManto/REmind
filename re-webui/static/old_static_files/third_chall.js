...
function downloadCFG(func) {
        ...
        $.post(base_url + "/third_chall/getBlock", data={'name':func, 'token':id}, function(data) {
...
function send_submission() {
    ...
    if(started == 0) {
        ...
        $.post(base_url + "/third_chall/storeSolution", data={'token':id, 'notes':note}, function(received) {
